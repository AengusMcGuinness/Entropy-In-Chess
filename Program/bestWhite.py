...
# conEntropies = []
    # count = 0
    # conditional = len(probabilities) - len(newProbabilities)
    # if (len(probabilities) > len(newProbabilities)):
    #     for i in range(conditional):
    #         newProbabilities.append(1)
    # else:
    #     for i in range((-1) * conditional):
    #         probabilities.append(1)
    # for dex, prob in enumerate(probabilities):
